        ...
        <div className="space-y-6 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">SkyOne HQ, Nairobi, Kenya</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">support@skyone.com</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
